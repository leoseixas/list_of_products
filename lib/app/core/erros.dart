...
class UserErrorSignUp implements FailureUser {
  final String message;

  UserErrorSignUp({this.message});
}

class UserErrorLogin implements FailureUser {
  final String message;

  UserErrorLogin({this.message});
}

abstract class FailureProduct implements Exception {}

class ProductErrorSave implements FailureProduct {
  final String message;

  ProductErrorSave({this.message});
}

class ProductErrorList implements FailureProduct {
  final String message;

  ProductErrorList({this.message});
}
